...
if __name__ == "__main__":
    answer_correctness_template = AnswerCorrectnessTemplate()
    # print(answer_correctness_template.generate_verdicts("rag是什么", ["rag是一种检索增强生成系统"], ["rag是一种检索增强生成系统"]))
    print(answer_correctness_template.generate_statements("你好", "你好"))
