"""Simple Optuna-based optimizer_name for model parameter tuning.
...
class ParameterOptimizer(BaseOptimizer):
    ...
    async def _optimize(
        ...
        **kwargs: Any,
        ...
        total_trials = n_trials if n_trials > 0 else self.default_n_trials
                ...
                "rounds": [
                    {
                        ...
                        "score": float(t.value) if t.value else None,
                        "stage": t.user_attrs.get("stage"),
                    }
