...
class ParameterSpec(BaseModel):
    ...
    distribution: ParameterType = Field(description="参数类型", alias="type")
    low: Optional[float] = Field(default=None, description="最小值", alias="min")
    high: Optional[float] = Field(default=None, description="最大值", alias="max")
