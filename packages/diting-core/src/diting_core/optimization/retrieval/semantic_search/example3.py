...
async def main():
    ...
    optimizer = SemanticSearchExhaustiveOptimizer(
        similarity_threshold_range=(0.4, 0.5),  # 缩小范围
        similarity_threshold_step=0.1,          # 增大步长以减少组合数
        context_recall_tokens_range=(4500, 5000),  # 合法范围
    ...
    try:
        ...
        fieldnames = [
            ...
            "per_item_metrics", "execution_time"
        ]
                ...
                for record in result.history:
                    if record["type"] == "evaluation":
                        row_data = {
                            ...
                            "run_logs": "N/A",
                            "per_item_metrics": "N/A",
                            "execution_time": record.get("execution_time", "N/A")
                        }
