...
class EvaluationDataset:
    ...
    def from_pandas(cls, dataframe: PandasDataframe):
        ...
        return cls.from_list(dataframe.to_dict(orient="records"))  # type: ignore[misc]

    @classmethod
    def from_hf_dataset(cls, dataset: "HFDataset") -> "EvaluationDataset":
        """Creates an EvaluationDataset from a Hugging Face Dataset."""
        return cls.from_list(dataset.to_list())  # type: ignore[misc]
    ...
    def to_hf_dataset(self) -> "HFDataset":
        ...
        return HFDataset.from_list(self.to_list())  # type: ignore[misc]
