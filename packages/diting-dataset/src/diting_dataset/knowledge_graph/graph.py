...
class Node(BaseModel):
    ...
    properties: t.Dict[str, t.Any] = Field(default_factory=dict)
...
class KnowledgeGraph:
    ...
    nodes: t.List[Node] = field(default_factory=list[Node])
    relationships: t.List[Relationship] = field(default_factory=list[Relationship])
    ...
    def find_indirect_clusters(
        ...
        """
        clusters: t.List[t.Set[Node]] = []
        visited_paths: t.Set[t.Tuple[Node, ...]] = set()
        ...
        for node in self.nodes:
            initial_cluster: t.Set[Node] = set()
    ...
    def find_two_nodes_single_rel(
        ...
        triplets: t.Set[t.Tuple[Node, Relationship, Node]] = set()
