...
class SummaryExtractor(LLMBasedExtractor):
    ...
    prompt: PydanticPrompt[StringIO, StringIO] = SummaryExtractorPrompt()
...
class KeyphrasesExtractor(LLMBasedExtractor):
    ...
    prompt: PydanticPrompt[TextWithExtractionLimit, Keyphrases] = (
...
class TitleExtractor(LLMBasedExtractor):
    ...
    prompt: PydanticPrompt[StringIO, StringIO] = TitleExtractorPrompt()
...
class TopicDescriptionExtractor(LLMBasedExtractor):
    ...
    prompt: PydanticPrompt[StringIO, TopicDescription] = TopicDescriptionPrompt()
...
class ThemesExtractor(LLMBasedExtractor):
    ...
    prompt: PydanticPrompt[TextWithExtractionLimit, ThemesAndConcepts] = (
