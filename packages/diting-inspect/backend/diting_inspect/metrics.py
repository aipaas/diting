...
class MetricOptionSchema(BaseModel):
    name: str = Field(..., description="metric algorithm name")
    threshold: float | None = Field(None, description="metric threshold")
    debug: bool | None = Field(None, description="metric debug")
