...
const EditCaseModal = ({ onClose, onSuccess, caseData }) => {
	...
	return (
		<div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
			<div className="relative top-20 mx-auto p-5 border shadow-lg rounded-md bg-white" style={{ width: modalWidth }}>
				<div className="resize-handle" onMouseDown={handleMouseDown} style={{ cursor: 'ew-resize', width: '10px', height: '100%', position: 'absolute', right: '0', top: '0' }} />
				<h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Edit Case</h3>
