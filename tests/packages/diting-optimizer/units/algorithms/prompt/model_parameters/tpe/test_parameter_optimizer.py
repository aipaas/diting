...
class TestParameterOptimizer:
    ...
    @pytest.mark.asyncio
    @patch(
        "diting_optimizer.algorithms.prompt.model_parameters.tpe.optimizer.evaluate_prompt",
        mock_evaluate_prompt,
    )
    @patch(
        "diting_optimizer.algorithms.prompt.model_parameters.tpe.optimizer.evaluate_prompt_sync",
        mock_evaluate_prompt_sync,
    )
